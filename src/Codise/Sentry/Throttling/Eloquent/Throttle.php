...
use Codise\Sentry\Throttling\UserSuspendedException;
use Codise\Sentry\Throttling\UserBannedException;
...
class Throttle extends Model implements ThrottleInterface {
	 ...
	 * @var string
	 */
	protected static $userModel = 'Codise\Sentry\Users\Eloquent\User';
